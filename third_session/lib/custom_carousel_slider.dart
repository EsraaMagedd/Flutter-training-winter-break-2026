...
import 'build_image_sliders.dart';
...
class _CustomCarouselSliderState extends State<CustomCarouselSlider> {
  ...
  void initState() {
    super.initState();
    future = NewsService().getHeadlinesNews('general');
  }
          ...
          return Column(
            children: [
              ...
              Row(
                ...
                children: imageSliders.sublist(0, 6).asMap().entries.map((entry) {
